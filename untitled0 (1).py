...
Original file is located at
    https://colab.research.google.com/drive/1fhAk3GaxqUssKpo2r4_-Ig0T83IiLfbq
"""
...
! unzip /content/deepfake-faces.zip -d 2041
...
metadata=pd.read_csv("/content/2041/metadata.csv")
crops_dir="/content/2041/faces_224"
...
def create_data_loaders(crops_dir, metadata_df, image_size, batch_size, num_workers):
    ...
    test_dataset = VideoDataset(crops_dir, val_df, "test", image_size, sample_size=None, seed=4321)
...
test_loss = test_loss / 4703 #test_data_len
